...
class OrderServiceTest {
    ...
    @Test
    void testCountOrdersByStatusZero() {
        long result = ordersService.countOrdersByStatus("pendingd");
        assertEquals(0,result);
    }

    @Test
    void testCountOrdersByStatusTwo() {
        long result = ordersService.countOrdersByStatus("finished");
