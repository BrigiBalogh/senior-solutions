...
public class MusicStoreControllerRestIT {
    ...
    void testAddNewInstruments() {
      ...
      InstrumentDTO result =
              template.postForObject("/api/instruments",
                       new CreateInstrumentCommand("Fender", InstrumentType.ELECTRIC_GUITAR, 2000),                       InstrumentDTO.class);
   ...
   void testUpdateInstrumentPrice(){
       ...
       template.put("/api/instruments/1", new UpdatePriceCommand(1000));InstrumentDTO result = template.getForObject("/api/instruments/1",InstrumentDTO.class);
